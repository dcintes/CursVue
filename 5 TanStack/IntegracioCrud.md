...
Una sèrie d'exemples explicats per a realitzar les peticions a l'API d'unc CRUD:
- Un element per id
- Llistat d'elements
...
La resta de peticions del crud, que no són GET, es poden concentrar en un composable.
